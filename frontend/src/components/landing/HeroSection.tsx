  ...
  return (
    <section className="relative flex min-h-screen items-center justify-center overflow-hidden px-6 pt-24">
      ...
      >
        ...
        >
          <motion.span variants={floatAnimation} animate="animate">
        ...
        <motion.h1
          variants={springItem}
          className="mb-6 font-heading text-4xl font-bold leading-tight tracking-tight text-foreground sm:text-5xl md:text-6xl lg:text-7xl"
        >
          Hệ Thống Thi
          <br />
